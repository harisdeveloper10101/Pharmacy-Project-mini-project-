...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pharma System");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("LRD Community");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      String query = "select * from AGENTTBLE where aname='"+uid.getText()+"' and apass='"+upassword.getText()+"'" ;
      try{
         ...
         else if(uid.getText().equals("Entity") && upassword.getText().equals("12345")){
              new Selling().setVisible(true);
             this.dispose();
         }
         else{
